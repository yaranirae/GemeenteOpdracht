    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <form action="{{ route('complaints.store') }}" method="POST" enctype="multipart/form-data" id="complaint-form">
                ...
                <!-- Description -->
                <div class="mb-6">
                    <label for="description" class="block font-medium text-gray-700 mb-2 after:content-['*'] after:text-red-500">Beschrijving van het probleem</label>
                ...
                <div class="mb-8">
                    ...
                    <div id="file-upload-area"
                        ...
                        <button type="button" class="px-4 py-2 border border-[#2d6a4f] text-[#2d6a4f] rounded hover:bg-[#f5fcf6]"
                    ...
                    <div id="photo-preview-container" class="hidden mt-4 text-center">
                        ...
                        <img id="photo-preview" class="max-w-full max-h-72 rounded-lg shadow-md mx-auto" src="#" alt="Voorbeeld van de foto">
                        <div class="mt-2">
                            <button type="button" class="px-3 py-1 text-sm border border-red-500 text-red-500 rounded hover:bg-red-50"
                                    onclick="removePhoto()">
...
>>>>>>> yara
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div>
                        <label for="latitude" class="block font-medium text-gray-700 mb-1">Breedtegraad (optioneel)</label>
                    ...
                    <div>
                        <label for="longitude" class="block font-medium text-gray-700 mb-1">Lengtegraad (optioneel)</label>
        ...
        <div class="text-center mt-6">
            <a href="{{ url('/') }}" class="inline-block px-4 py-2 border border-[#1b4332] text-[#1b4332] rounded hover:bg-gray-100">
